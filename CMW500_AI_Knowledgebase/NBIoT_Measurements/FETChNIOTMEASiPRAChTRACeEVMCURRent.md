# FETChNIOTMEASiPRAChTRACeEVMCURRent

Module: NBIoT Measurements
Source: 1a70f3b1553749ba.htm
...
Return the values of the EVM vs. symbol traces. Each value is averaged over the samples in one preamble symbol. The results of the current, average and maximum traces can be retrieved.
See also 
