# FETChWLANMEASiMEValuationLISTSEGMentSegTSMaskDSSSCURRent

Module: WLAN Measurements
Source: 4e5e254a9f1b4fbe.htm
...
Return limit line margin results (DSSS signal) for segment <Seg> in list mode.
