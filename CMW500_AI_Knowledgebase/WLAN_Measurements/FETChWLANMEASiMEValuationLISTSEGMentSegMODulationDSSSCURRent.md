# FETChWLANMEASiMEValuationLISTSEGMentSegMODulationDSSSCURRent

Module: WLAN Measurements
Source: 2494872308454d3e.htm
...
Return modulation single value results (DSSS signal) for segment <Seg> in list mode.
Suffix: 
<Seg>
1..100
Return values: 
