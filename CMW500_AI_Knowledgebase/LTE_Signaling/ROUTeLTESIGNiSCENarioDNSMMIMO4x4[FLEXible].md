# ROUTeLTESIGNiSCENarioDNSMMIMO4x4[FLEXible]

Module: LTE Signaling
Source: 0aeccb8d6efa41d2.htm
...
ROUTe:LTE:SIGN<i>:SCENario:DNSM<MIMO4x4>[:FLEXible] 
<PCCBBBoard>, <PCCRXConnector>, <PCCRXConverter>, <PCCTX1Connector>, <PCCTX1Converter>, <PCCTX2Connector>, <PCCTX2Converter>, <SCC1BBBoard>, <SCC1TX1Conn>, <SCC1TX1Conv>, <SCC1TX2Conn>, <SCC1TX2Conv>, <SCC1TX3Conn>, <SCC1TX3Conv>, <SCC1TX4Conn>, <SCC1TX4Conv>, <SCC2BBBoard>, <SCC2TX1Conn>, <SCC2TX1Conv>, <SCC2TX2Conn>, <SCC2TX2Conv>, <SCC2TX3Conn>, <SCC2TX3Conv>, <SCC2TX4Conn>, <SCC2TX4Conv>, <SCC3BBBoard>, <SCC3TX1Conn>, <SCC3TX1Conv>, <SCC3TX2Conn>, <SCC3TX2Conv>, <SCC3TX3Conn>, <SCC3TX3Conv>, <SCC3TX4Conn>, <SCC3TX4Conv>[, <Coprocessor>]
Activates the scenario "4CC - nx2 nx4 nx4 nx4" and selects the signal paths.
...
<SCC1TX3Conn>
RF connector for the third SCC1 output path
<SCC1TX3Conv>
TX module for the third SCC1 output path
<SCC1TX4Conn>
RF connector for the fourth SCC1 output path
<SCC1TX4Conv>
TX module for the fourth SCC1 output path
<SCC2BBBoard>
...
<SCC2TX3Conn>
RF connector for the third SCC2 output path
<SCC2TX3Conv>
TX module for the third SCC2 output path
<SCC2TX4Conn>
RF connector for the fourth SCC2 output path
<SCC2TX4Conv>
TX module for the fourth SCC2 output path
<SCC3BBBoard>
...
<SCC3TX3Conn>
RF connector for the third SCC3 output path
<SCC3TX3Conv>
TX module for the third SCC3 output path
<SCC3TX4Conn>
RF connector for the fourth SCC3 output path
<SCC3TX4Conv>
TX module for the fourth SCC3 output path
<Coprocessor>
