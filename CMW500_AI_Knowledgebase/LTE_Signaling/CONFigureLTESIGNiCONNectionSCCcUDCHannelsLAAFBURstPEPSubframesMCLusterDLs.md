# CONFigureLTESIGNiCONNectionSCCcUDCHannelsLAAFBURstPEPSubframesMCLusterDLs

Module: LTE Signaling
Source: 74bacdf50ac54a30.htm
...
The <Cluster> setting applies to all subframes of the burst and to all DL streams. The other settings apply to ending subframes with partial allocation and DL stream <s>.
