# CONFigureLTESIGNiCONNectionSCCcUDCHannelsLAARBURstPIPSubframesDLs

Module: LTE Signaling
Source: 843a292aaa6a4daf.htm
...
The <NumberRB> and <StartRB> settings apply to all subframes of the burst and to all DL streams. The other settings apply to initial subframes with partial allocation and DL stream <s>.
