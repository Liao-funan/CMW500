# CONFigureLTESIGNiCONNectionSCCcUDCHannelsLAAFBURstFSUBframesMCLusterDLs

Module: LTE Signaling
Source: bfa07c439ad44dae.htm
...
The <Cluster> setting applies to all subframes of the burst and to all DL streams. The other settings apply to subframes with full allocation and DL stream <s>.
