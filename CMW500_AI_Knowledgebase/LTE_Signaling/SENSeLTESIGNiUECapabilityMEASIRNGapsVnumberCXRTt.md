# SENSeLTESIGNiUECapabilityMEASIRNGapsVnumberCXRTt

Module: LTE Signaling
Source: 0ba1f86237c24509.htm
...
SENSe:LTE:SIGN<i>:UECapability:MEAS:IRNGaps:V<number>:CXRTt? 
[<Index>]
Returns a list of values indicating the need for downlink measurement gaps when operating on a specific E-UTRA band combination and measuring on a specific CDMA2000 1xRTT band class.
