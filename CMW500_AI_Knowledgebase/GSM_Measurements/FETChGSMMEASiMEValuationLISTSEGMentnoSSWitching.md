# FETChGSMMEASiMEValuationLISTSEGMentnoSSWitching

Module: GSM Measurements
Source: c79257649a354dd5.htm
...
Returns the spectrum due to switching results for segment <no> in list mode. The result corresponds to the maximum over the statistical length (peak hold mode).
