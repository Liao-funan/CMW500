# FETChWCDMaSIGNiULLoggingDCARrier

Module: WCDMA Signaling
Source: cf9d28fa8b4e4429.htm
...
DTX |
 ...
 NACK
HARQ ACK: UE response (by dual carrier - carrier one)
DTX:
 no answer received from the UE
ACK:
...
DTX |
 ...
 30
UE response (by dual carrier - carrier one); 30 means the best quality
DTX:
 no answer received from the UE
0 to 30:
...
ACK |
 ...
 DTX
HARQ ACK: UE response (by dual carrier - carrier two)
ACK:
 successful CRC check of a received transmission packet
NACK:
 failed CRC check of a received transmission packet
...
DTX |
 ...
 30
UE response (by dual carrier - carrier two); 30 means the best quality
DTX:
 no answer received from the UE
0 to 30:
 reported channel quality indicator
...
Options: 
R&S CMW-KS401
R&S CMW-KS404 for dual carrier
Top