# ROUTeWCDMaSIGNiSCENarioSCFDiversityFLEXible[EXTernal]

Module: WCDMA Signaling
Source: 5b00e2e5086b490d.htm
...
<IQConnector>
DIG IQ OUT connector for external fading of the first output path.
<IQ2Connector>
DIG IQ OUT connector for external fading of the second output path. Select different connectors for the two paths.
Example: 
See 
