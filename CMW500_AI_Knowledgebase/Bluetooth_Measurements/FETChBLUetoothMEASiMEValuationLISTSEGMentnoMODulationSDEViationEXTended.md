# FETChBLUetoothMEASiMEValuationLISTSEGMentnoMODulationSDEViationEXTended

Module: Bluetooth Measurements
Source: b474091af4d94808.htm
...
FETCh:BLUetooth:MEAS<i>:MEValuation:LIST:SEGMent<no>:MODulation:SDEViation:EXTended? 
Returns modulation single value results for segment<no> in list mode including Bluetooth version 5.0.
...
Hz
<16_Δf1 99.9%>
Frequency deviation value Δf1 above which 99.9% of all measured Δf1 values occur (LE coded PHY)
Range: 
-0.99999E+6 Hz  to  0.99999E+6 Hz
Default unit: 
Hz
